...
namespace Ray.Util.Console.Scene
{
    class PlaneWorld
    {
        ...
        {
            // TODO: Comment to explain this verbose syntax:
            //   serialize scene, stand up api, use docker etc.
...
#pragma warning restore CS0219 // Variable is assigned but its value is never used
            ...
            var scene = new SceneDto
            {
                ...
                LightSource = new LightDto
                {
                    ...
                    {
                        A = white.ScA, R = white.R, G = white.G, B = white.B
                    }
                },
                Camera = new CameraDto
                {
                    HSize = res, VSize = res / 2, FieldOfView = MathF.PI / 3,
